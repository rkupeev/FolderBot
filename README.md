...
**Folder Bot** – бот, хранящий в себе записи, отправленные ему в виде сообщений.
...
### Профиль
В данном разделе представлена основная информация о пользователе (доступно только для личных сообщений боту, в группе такой функционал не поддерживается). 

Основная информация предполагает наличие даты регистрации в боте, а также некоторые простые элементы (например, ID в Telegram-е и счетчик записей в хранилище). 
